 ...
 *              : build the RFS demo application.                              *
 *                                                                             *
...
with a RF sensor device. More specifically, how to start the detection and
decode threat indication messages.
