...
public interface IMdifCore {
    ...
    void onGetPingRes(Core.PingRes pingRes);

    void onGetBatteryStatusRes(Core.GetBatteryStatusRes getBatteryStatusRes);

    void onResetRes(Core.ResetRes resetRes);

    void onSetIpConfigRes(Core.SetIpConfigRes setIpConfigRes);
}
