...
public interface IMdifRfs {
    void onGetWifiThreatInd(Rfs.WifiThreatInd wifiThreatInd);

    void onGetThreatStoppedInd(Rfs.ThreatStoppedInd threatStoppedInd);

    void onGetRfsThreatInd(Rfs.RfsThreatInd rfsThreatInd);
